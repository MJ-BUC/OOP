...
// Lab Assignment #14 - bucaro_mark_lab14.cpp
// Code Summary: This source code file demonstrates Operator/Method Overloading using a multi-file CPP application.
...
int main(){
    ...
    // Sort and print all Students by (last name, first name)
    ...
    // Find names and degree for students with a 4.0 gpa
    for (int x = 0; x<20; x++){
    ...
    // Calculate average gpa for each of degree types e.g.(UG, G, PG, D).
    ...
    for (int y = 0; y<20; y++){
        // Read the degrees and append to proper vector
    ...
    // Sort the GPA for degrees and display each list
